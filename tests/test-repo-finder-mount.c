                                  ...
                                  gconstpointer  test_data)
{
  ...
  g_autoptr(GError) error = NULL;
  const OstreeCollectionRef ref1 = { "collection1", "exampleos/x86_64/standard" };
  const OstreeCollectionRef ref2 = { "collection1", "exampleos/x86_64/buildmaster/standard" };
  const OstreeCollectionRef ref3 = { "collection2", "exampleos/x86_64/standard" };
  const OstreeCollectionRef ref4 = { "collection2", "exampleos/arm64/standard" };
                                     ...
                                     gconstpointer  test_data)
{
  ...
  gsize i;
  const OstreeCollectionRef ref0 = { "collection1", "exampleos/x86_64/ref0" };
  const OstreeCollectionRef ref1 = { "collection1", "exampleos/x86_64/ref1" };
  const OstreeCollectionRef ref2 = { "collection1", "exampleos/x86_64/ref2" };
  const OstreeCollectionRef ref3 = { "collection1", "exampleos/x86_64/ref3" };
  const OstreeCollectionRef ref4 = { "unconfigured-collection", "exampleos/x86_64/ref4" };
  const OstreeCollectionRef ref5 = { "collection3", "exampleos/x86_64/ref0" };
  ...
  assert_create_repo_symlink (repo1_repos, refs[5], "../../../collection1/exampleos/x86_64/ref0");  /* repo1_repo_a */
  ...
  assert_create_remote_config (fixture->parent_repo, "remote1", "https://nope1", "collection1");
  assert_create_remote_config (fixture->parent_repo, "remote2", "https://nope2", "collection2");
  /* don’t configure unconfigured-collection */
  assert_create_remote_config (fixture->parent_repo, "remote3", "https://nope3", "collection3");
