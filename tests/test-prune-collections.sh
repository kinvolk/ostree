...
set_up_repo() {
  ...
  popd
  ${CMD_PREFIX} ostree --repo=repo refs --collections --create=some-cid:some-ref $(cat original-ref-checksum)
}
...
${CMD_PREFIX} ostree --repo=repo refs --collections --delete some-cid
