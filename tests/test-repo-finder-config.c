                                    ...
                                    gconstpointer  test_data)
{
  ...
  g_autoptr(GError) error = NULL;
  const OstreeCollectionRef ref1 = { "exampleos", "exampleos/x86_64/standard" };
  const OstreeCollectionRef ref2 = { "exampleos", "exampleos/x86_64/buildmaster/standard" };
                                       ...
                                       gconstpointer  test_data)
{
  ...
  g_autoptr(GError) error = NULL;
  gsize i;
  const OstreeCollectionRef ref0 = { "collection0", "exampleos/x86_64/ref0" };
  const OstreeCollectionRef ref1 = { "collection0", "exampleos/x86_64/ref1" };
  const OstreeCollectionRef ref2 = { "collection1", "exampleos/x86_64/ref1" };
  const OstreeCollectionRef ref3 = { "collection1", "exampleos/x86_64/ref2" };
  const OstreeCollectionRef ref4 = { "collection2", "exampleos/x86_64/ref3" };
  ...
  g_autofree gchar *collection0_uri = assert_create_remote (fixture, "collection0",
                                                            "exampleos/x86_64/ref0",
                                                            "exampleos/x86_64/ref1",
                                                            NULL);
  g_autofree gchar *collection1_uri = assert_create_remote (fixture, "collection1",
  ...
  assert_create_remote_config (fixture->parent_repo, "remote0", collection0_uri, "collection0");
  assert_create_remote_config (fixture->parent_repo, "remote1", collection1_uri, "collection1");
  assert_create_remote_config (fixture->parent_repo, "remote0-copy", collection0_uri, "collection0");
  assert_create_remote_config (fixture->parent_repo, "remote1-bad-copy", collection1_uri, "not-collection1");
